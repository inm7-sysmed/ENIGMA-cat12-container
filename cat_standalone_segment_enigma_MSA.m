...
matlabbatch{1}.spm.tools.cat.estwrite.output.ROImenu.atlases.ownatlas = {'code/MSA/3T/Subcortex-Only/Tian_Subcortex_S1_3T_2009cAsym.nii.gz'};
matlabbatch{1}.spm.tools.cat.estwrite.output.ROImenu.atlases.ownatlas = {'code/MSA/3T/Subcortex-Only/Tian_Subcortex_S2_3T_2009cAsym.nii.gz'};
matlabbatch{1}.spm.tools.cat.estwrite.output.ROImenu.atlases.ownatlas = {'code/MSA/3T/Subcortex-Only/Tian_Subcortex_S3_3T_2009cAsym.nii.gz'};
matlabbatch{1}.spm.tools.cat.estwrite.output.ROImenu.atlases.ownatlas = {'code/MSA/3T/Subcortex-Only/Tian_Subcortex_S4_3T_2009cAsym.nii.gz'};
