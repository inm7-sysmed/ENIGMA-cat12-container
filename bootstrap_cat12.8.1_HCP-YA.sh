...
input_store="ria+file:///data/project/cat_preprocessed/inputstore"
# define the output ria-store to push all results to
output_store="ria+file:///data/project/cat_preprocessed/dataladstore"

# define the location of the stores all analysis inputs will be obtained from
raw_store="ria+file:///data/project/cat_preprocessed/dataladstore#~HCP-YA-struct_BIDS"
